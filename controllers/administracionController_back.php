...
class administracionController extends Controller {
	...
	public function insertDerivar(){
		...
		if($reiterado==1){
			...
			$update_reiterado=$objModel->getUpdatereiterado($codigo_pedido,$iduser);

			if($update_reiterado==0){
				echo "4";
				exit;
			}
		}
		
		$insert_derivar=$objModel->insertDerivar($gestion,$actividado,$codigo_pedido,$telefono,$tematico_combo,$obs_derivar,
